...
public class UserTest extends TestBase {
    ...
    public void loginAndCheckExistingOrders() {
        ...
        assertEquals(driver.findElement(MobileBy.AccessibilityId("number-of-orders")).getText(), "5 order(s) found.");
    }
    ...
    public void addToFavourites() {
        ...
        assertEquals(driver.findElement(MobileBy.AccessibilityId("number-of-favourites")).getText(), "2 product(s) marked favourite.");
    }
}
