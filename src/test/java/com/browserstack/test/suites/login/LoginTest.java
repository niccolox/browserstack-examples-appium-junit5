...
public class LoginTest extends TestBase {
    ...
    public void loginLockedUser() {
        ...
        assertEquals(driver.findElement(MobileBy.AccessibilityId("api-error")).getText(), "Your account has been locked.");
    }
    ...
    public void loginSuccess() {
        ...
        driver.findElement(MobileBy.AccessibilityId("login-btn")).click();
        driver.findElement(MobileBy.AccessibilityId("menu")).click();
        assertEquals(driver.findElement(MobileBy.AccessibilityId("username")).getText(), "Welcome fav_user");
    }
    ...
    public void loginFail() {
        ...
        driver.findElement(MobileBy.AccessibilityId("login-btn")).click();
        assertEquals(driver.findElement(MobileBy.AccessibilityId("api-error")).getText(), "Invalid Password");
    }
}
